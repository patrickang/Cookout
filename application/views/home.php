...
<header class="navbar navbar-inverse navbar-fixed-top" id="top" role="banner">
	  <div class="container">
	    <div class="navbar-header">
	      ...
	      <a href="#" class="">
	      	<img src="<?php echo base_url();?>assets/images/cookout_logo.png" class="navbar-logo"/>
	      </a>
	    </div>
	...
	<section  class="about-us initial-section" id="about_us">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5">
					<img class="heading-image img-responsive" src="<?php echo base_url();?>assets/images/about_square.png"/>
				</div>
			</div>
		</div>
	</section>
